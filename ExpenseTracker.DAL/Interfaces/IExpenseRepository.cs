...
namespace ExpenseTracker.DAL.Interfaces
{
    public interface IExpenseRepository
    {
        ...
        Task<(List<Expense> data, decimal totalExpense, HighestExpenseResDto? highestExpense, int totalCount, bool hasNextPage)> GetExpensesByUserAsync(int userId, int page = 1, int limit = 12, string? search = null);
